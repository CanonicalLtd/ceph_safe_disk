...
pub struct PgStats {
    ...
    pub state: String,
    pub version: String,
    pub last_became_peered: String,
    pub last_undegraded: String,
    pub pgid: String,
    pub parent: String,
    pub acting: Vec<i32>,
    pub up_primary: i32,
    pub last_fullsized: String,
...
mod tests {
    ...
    fn pgmap_from_jewel_file_no_osd_panic() {
        ...
        assert_eq!(pgmap.pg_stats.first().unwrap().state, "active+clean".to_owned());
    }
